...
# =========================
#
# @app.get("/api/example/bot_config")
# async def example_get_bot_config() -> dict:
#     obj = await client.get_one(BotConfig, {"id": 1})
#     return {"data": None if obj is None else _to_dict(obj)}
